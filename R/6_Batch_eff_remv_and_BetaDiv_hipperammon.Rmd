...
plot(permdisp, main="PCoA relative abundance", hull=FALSE, ellipse=TRUE, segments = TRUE, seg.col = c("#F8766D", "#00B0F6"), col = c("#F8766D", "#00B0F6"), label = TRUE, label.cex = 1.2, pch = c(20, 20, 20), seg.lty = c(1), seg.lwd = 1, cex.lab = 1.2, cex.main =1.3, xlab = paste0('PCoA1 14.77%'), ylab = paste0('PCoA2 8.62 %'))
