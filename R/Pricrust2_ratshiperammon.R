...
write_biom(biom.tmp, biom_file = "/fast/AG_Forslund/Lola/Datos_CIPF_2023/Rats_HE_HiperAmmon_model/input/asv_ratshiperammon.biom")
...
writeXStringSet(dna, filepath = "/fast/AG_Forslund/Lola/Datos_CIPF_2023/Rats_HE_HiperAmmon_model/input/dna_ratshiperammon.fasta") 